...
1) Run `./gradlew :nftools:publishToMavenLocal`
2) Open `~/.m2/repository/io/github/kdroidfilter/netfreetools/"}`
...
4) Add the secrets to `local.properties`:
   ...
   ```
5) Run `./gradlew :nftools:publishAllPublicationsToSonatypeRepository`
